...
export default function FastWay() {
  return (
    <div className="relative bg-primary overflow-hidden px-4 md:px-12 lg:px-[180px]">
      ...
      <div className="relative pt-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center justify-start">
        {/* Left Side Content */}
        <div className="text-center flex-1 flex flex-col items-center lg:items-start lg:text-left relative z-30 ">
          <h1 className="text-3xl md:text-4xl md:leading-[38px] lg:text-5xl font-bold text-white lg:leading-[55px] mb-6">
            The fastest way to buy, <br />
            sell, or rent homes
          </h1>
          <p className="text-white  text-sm px-[50px] lg:text-lg mb-8 text-center lg:text-left md:px-[135px] lg:px-[0px] lg:max-w-[460px]">
          ...
          <button className="px-6 py-3 w-[200px] bg-white max-w-[200px] text-[#41c8c8] font-medium rounded-lg shadow-md hover:bg-gray-100 transition">
            Explore App
          </button>
        </div>
